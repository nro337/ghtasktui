...
## [0.6.0] - 2026-08-23
- Add togglable grid option to settings menu for board view

## [0.5.1] - 2026-08-22
- Fix project switching not loading tasks

## [0.5.0] - 2026-08-22
- Added high-contrast mode
- Allow real-time view of themes when changing between them in TUI settings

## [0.4.0] - 2026-06-23
### descriptions, comments, and converting draft items to issues
- Added support for adding descriptions to items
- Added support for adding comments to items
- Added support for converting draft items to issues
